...
# Frame para contener el Text y la Scrollbar
frame = tk.Frame(root)
frame.pack(fill="both", expand=True, padx=10, pady=10)

# Widget Text con contenido largo
texto = tk.Text(
    frame,
    wrap="word",
    width=50,
...
# Configurar la conexión entre Text y Scrollbar
...
contenido_largo = """Introduction to a book about the history of colour
